...
Spikes live in `.planning/spikes/` and integrate with GTD commit patterns, state tracking,
...
<execution_context>
@~/.claude/get-tasks-done/workflows/spike.md
@~/.claude/get-tasks-done/workflows/spike-wrap-up.md
