...
integrate with GTD commit patterns, state tracking, and handoff workflows. Loads spike
...
<execution_context>
@~/.claude/get-tasks-done/workflows/sketch.md
@~/.claude/get-tasks-done/workflows/sketch-wrap-up.md
