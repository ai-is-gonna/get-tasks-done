---
name: gtd:workspace
description: Manage GTD workspaces — create, list, or remove isolated workspace environments
...
<objective>
Manage GTD workspaces with a single consolidated command.

Mode routing:
- **--new**: Create an isolated workspace with repo copies and independent .planning/ → new-workspace workflow
- **--list**: List active GTD workspaces and their status → list-workspaces workflow
- **--remove**: Remove a GTD workspace and clean up worktrees → remove-workspace workflow
</objective>
...
| --list | Scan ~/gtd-workspaces/, show summary table | list-workspaces |
| --remove | Confirm and remove workspace directory | remove-workspace |

</routing>

<execution_context>
@~/.claude/get-tasks-done/workflows/new-workspace.md
@~/.claude/get-tasks-done/workflows/list-workspaces.md
@~/.claude/get-tasks-done/workflows/remove-workspace.md
