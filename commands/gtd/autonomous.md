...
Project context, phase list, and state are resolved inside the workflow using init commands (`gtd-sdk query init.milestone-op`, `gtd-sdk query roadmap.analyze`). No upfront context loading needed.
</context>
