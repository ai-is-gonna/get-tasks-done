...
<objective>
Capture ideas, tasks, notes, and seeds to their appropriate destination in the GTD system.
...
<execution_context>
@~/.claude/get-tasks-done/workflows/add-todo.md
@~/.claude/get-tasks-done/workflows/note.md
@~/.claude/get-tasks-done/workflows/add-backlog.md
@~/.claude/get-tasks-done/workflows/plant-seed.md
@~/.claude/get-tasks-done/workflows/check-todos.md
