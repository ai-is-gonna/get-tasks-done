...
<objective>
Analyze existing codebase using parallel gtd-codebase-mapper agents to produce structured codebase documents.
...
<execution_context>
@~/.claude/get-tasks-done/workflows/map-codebase.md
</execution_context>
...
- Before /gtd:new-project (brownfield codebases) - creates codebase map first
- After /gtd:new-project (greenfield codebases) - updates codebase map as code evolves
...
3. Spawn 4 parallel gtd-codebase-mapper agents:
...
7. Offer next steps (typically: /gtd:new-project or /gtd:plan-phase)
</process>
