...
Spawned by the `/gtd:docs-update` workflow. Each spawn receives a `<verify_assignment>` XML block containing:
...
- **GTD marker**: The comment `<!-- generated-by: gtd-doc-writer -->` — skip entirely.
