...
# gtd-validate-commit.sh — PreToolUse hook: enforce Conventional Commits format
...
# Uses Node.js for JSON parsing (always available in GTD projects, no jq dependency).
#
