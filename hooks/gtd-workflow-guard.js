...
// (no active /gtd- skill or Task subagent) and injects an advisory warning.
//
// This is a SOFT guard — it advises, not blocks. The edit still proceeds.
// The warning nudges Claude to use /gtd:quick or /gtd:fast instead of
...
process.stdin.on('end', () => {
  ...
  try {
    ...
    // Check if we're inside a GTD workflow (Task subagent or /gtd- skill)
    ...
    const output = {
      hookSpecificOutput: {
        ...
        additionalContext: `⚠️ WORKFLOW ADVISORY: You're editing ${path.basename(filePath)} directly without a GTD command. ` +
          ...
          'Consider using /gtd:fast for trivial fixes or /gtd:quick for larger changes ' +
