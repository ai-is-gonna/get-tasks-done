<purpose>
Retroactive 6-pillar visual audit of implemented frontend code. Standalone command that works on any project — GTD-managed or not. Produces scored UI-REVIEW.md with actionable findings.
</purpose>
...
- gtd-ui-auditor — Audits UI against design requirements
</available_agent_types>
...
AGENT_SKILLS_UI_REVIEWER=$(gtd-sdk query agent-skills gtd-ui-auditor)
```

Parse: `phase_dir`, `phase_number`, `phase_name`, `phase_slug`, `padded_phase`, `commit_docs`.

```bash
UI_AUDITOR_MODEL=$(gtd-sdk query resolve-model gtd-ui-auditor --raw)
```

Display banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 GTD ► UI AUDIT — PHASE {N}: {name}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
**If `SUMMARY_FILES` empty:** Exit — "Phase {N} not executed. Run /gtd:work-task-issue --phase {N} first."
...
```markdown
Read ~/.claude/agents/gtd-ui-auditor.md for instructions.
...
- `/gtd:verify-work {N}` — UAT testing
- `/gtd:plan-phase {N+1}` — plan next phase
...
```bash
gtd-sdk query commit "docs(${padded_phase}): UI audit review" --files "${PHASE_DIR}/${PADDED_PHASE}-UI-REVIEW.md"
```
...
- [ ] gtd-ui-auditor spawned with correct context
