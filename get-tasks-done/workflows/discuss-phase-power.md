...
<trigger>
This workflow executes when `--power` flag is present in ARGUMENTS to `/gtd:discuss-phase`.
...
Consider running /gtd:discuss-phase {N} again to refine before planning.
```
