...
Offload GTD's plan phase to Claude Code's ultraplan cloud infrastructure.

⚠ **BETA feature.** Ultraplan is in research preview and may change. This workflow is
intentionally isolated from /gtd:plan-phase so upstream changes to ultraplan cannot
...
```text
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 GTD ► ULTRAPLAN PHASE  ⚠ BETA
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Ultraplan is in research preview (Claude Code v2.1.91+).
Use /gtd:plan-phase for stable local planning.
```
...
/gtd:ultraplan-phase requires Claude Code.
ultraplan is not available in this runtime.

Use /gtd:plan-phase for local planning instead.
```
...
unplanned phase from the roadmap (same logic as /gtd:plan-phase).

Load GTD phase context:
...
Build the ultraplan prompt from GTD context.
...
Produce a GTD PLAN.md with the following YAML frontmatter:
...
When ◆ ultraplan ready appears in your terminal:
  ...
  7. Run: /gtd:import --from <the file path>

/gtd:import will run conflict detection, convert to GTD format,
