...
4. If nothing found: error "No milestone found. Run /gtd:new-project or /gtd:new-milestone first."
...
```bash
gtd-sdk query commit "docs(v${VERSION}): generate milestone summary for onboarding" --files \
...
If the user is done:
- Suggest next steps: `/gtd:new-milestone`, `/gtd:progress`, or sharing the summary with the team
