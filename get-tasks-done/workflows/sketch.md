...
Companion to `/gtd:sketch --wrap-up`.
...
@~/.claude/get-tasks-done/references/sketch-theme-system.md
@~/.claude/get-tasks-done/references/sketch-variant-patterns.md
@~/.claude/get-tasks-done/references/sketch-interactivity.md
@~/.claude/get-tasks-done/references/sketch-tooling.md
</required_reading>
...
```bash
gtd-sdk query commit "docs(sketch-NNN): [winning direction] — [key visual insight]" --files .planning/sketches/NNN-descriptive-name/ .planning/sketches/MANIFEST.md
```
...
**Also available:**
- `/gtd:sketch` — sketch more (or run with no argument for frontier mode)
- `/gtd:plan-phase` — start building the real UI
- `/gtd:spike` — spike technical feasibility of a design pattern
