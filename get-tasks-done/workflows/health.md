...
```bash
gtd-sdk query validate.context \
...
```bash
gtd-sdk query validate.health $REPAIR_FLAG $BACKFILL_FLAG
```
...
- [E001] config.json: JSON parse error at line 5
  Fix: Run /gtd:health --repair to reset to defaults

- [E002] PROJECT.md not found
  Fix: Run /gtd:new-project to create
```
...
```
---
N issues can be auto-repaired. Run: /gtd:health --repair
```
</step>
...
```
Would you like to run /gtd:health --repair to fix N issues automatically?
```
...
| W019 | warning | Unrecognized .planning/ root file — not a canonical GTD artifact | No |
