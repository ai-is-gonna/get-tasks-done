...
Use /gtd:quick for anything that needs multi-step planning or research.
</purpose>
...
```
This looks like it needs planning. Use /gtd:quick instead:
  /gtd:quick "{task description}"
```
...
- If the task takes more than 3 file edits, STOP and redirect to /gtd:quick
- If you're unsure how to implement it, STOP and redirect to /gtd:quick
</guardrails>
