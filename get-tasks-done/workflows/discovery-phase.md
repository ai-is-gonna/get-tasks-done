...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /gtd:plan-phase --research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/get-tasks-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/get-tasks-done/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/get-tasks-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/get-tasks-done/templates/discovery.md
...
Use ~/.claude/get-tasks-done/templates/discovery.md.
...
1. Discuss phase context (/gtd:discuss-phase [current-phase])
2. Create phase plan (/gtd:plan-phase [current-phase])
