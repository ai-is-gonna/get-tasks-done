...
> **Note:** Planning methodology is in `agents/gtd-planner.md`.
...
@~/.claude/get-tasks-done/templates/summary.md
[If plan contains checkpoint tasks (type="checkpoint:*"), add:]
@~/.claude/get-tasks-done/references/checkpoints.md
</execution_context>
...
<task type="auto">
  ...
  <boundaries>[Allowed scope and forbidden changes. Include concrete directories/files this task may touch, files it must not touch, and behavior explicitly out of scope.]</boundaries>
...
<task type="auto">
  ...
  <boundaries>[Allowed scope and forbidden changes for this task]</boundaries>
...
<!-- For checkpoint task examples and patterns, see @~/.claude/get-tasks-done/references/checkpoints.md -->
...
**Wave is pre-computed:** Wave numbers are assigned during `/gtd:plan-phase`. Execute-phase reads `wave` directly from frontmatter and groups plans by wave number. No runtime dependency analysis needed.

**Must-haves enable verification:** The `must_haves` field carries goal-backward requirements from planning to execution. After all plans complete, task orchestration flow spawns a verification subagent that checks these criteria against the actual codebase.
...
See `~/.claude/get-tasks-done/references/tdd.md` for TDD plan structure.
...
<task type="auto">
  ...
  <boundaries>Allowed: user model file only. Forbidden: API endpoints, UI components, database schema, and unrelated feature modules.</boundaries>
...
<task type="auto">
  ...
  <boundaries>Allowed: user API endpoint file and direct imports from the user model. Forbidden: UI components, unrelated endpoints, authentication middleware changes, and database schema changes.</boundaries>
...
<task type="auto">
  ...
  <boundaries>Allowed: dashboard component and direct layout styles. Forbidden: modifying UserList/ProductList internals, API routes, database models, or global theme tokens.</boundaries>
...
<task type="auto">
  ...
  <boundaries>Allowed: database connection config and `.env.example` entries named in this task. Forbidden: migration files, application query logic, Docker service topology, and unrelated environment variables.</boundaries>
...
See `~/.claude/get-tasks-done/templates/user-setup.md` for full schema and examples
...
See `~/.claude/get-tasks-done/workflows/verify-phase.md` for verification logic.
