...
- This section feeds directly into /gtd:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /gtd:plan-phase --gaps with root causes
...
**Creation:** When /gtd:verify-work starts new session
...
- `/gtd:verify-work {phase}` picks up from first pending/blocked test
