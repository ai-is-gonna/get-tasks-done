...
For deep ecosystem research ("how do experts build this"), use `/gtd:plan-phase --research-phase` which produces RESEARCH.md.
...
- Use `/gtd:plan-phase --research-phase` for these
</guidelines>
