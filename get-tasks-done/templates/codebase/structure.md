...
│   └── gtd/           # GTD-specific commands
├── get-tasks-done/     # Skill resources
...
- Key files: new-project.md, plan-phase.md, work-task-issue.md
- Subdirectories: None (flat structure)

**get-tasks-done/references/**
...
- Key files: work-task-issue.md, research-phase.md
- Subdirectories: None
...
**New Slash Command:**
- Primary code: `commands/gtd/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `get-tasks-done/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `get-tasks-done/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/get-tasks-done/workflows/{name}.md`

**New Reference Document:**
- Implementation: `get-tasks-done/references/{name}.md`
