...
import { isRootPlanFile, isNestedPlanFile } from './plan-scan.js';
import {
  normalizeGitHubRepo,
...
import {
  ...
  issueLabels as labelNamesFromIssue,
  normalizeTaskType,
...
function buildWriteMode(cwd, opts, adapterOverride = null) {
  ...
  try {
    ...
    failure.message = [
      ...
      `Safe rerun: gtd-sdk query export-phase-issues ${opts.phase} --repo ${repo}`,
    ].join('\n');
    throw failure;
  }
}
