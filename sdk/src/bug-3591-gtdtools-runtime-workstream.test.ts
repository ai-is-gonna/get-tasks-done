/**
 * Bug #3591: createGTDToolsRuntime accepts a `workstream` option, but the
 ...
 * `.planning/workstreams/<name>` whenever a GTDTools instance was created
...
describe('bug #3591: createGTDToolsRuntime forwards workstream to registry.dispatch', () => {
