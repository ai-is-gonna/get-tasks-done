...
/**
 * Extract the tools list from a gtd-task-executor.md agent definition.
...
/**
 * Extract the role instructions from a gtd-task-executor.md agent definition.
...
export interface ExecutorPromptOptions {
  /** Raw content of gtd-task-executor.md agent definition. */
  agentDef?: string;
