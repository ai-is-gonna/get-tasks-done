/**
 * Tests for issue #2912 — /gtd-progress can use stale CLAUDE.md project block
 * instead of GTD tracking files as authoritative source.
 *
 * Fix: the `report` step in get-tasks-done/workflows/progress.md must contain
