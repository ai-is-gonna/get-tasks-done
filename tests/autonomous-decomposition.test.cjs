...
const AUTONOMOUS_PATH = path.join(PROJECT_ROOT, 'get-tasks-done', 'workflows', 'autonomous.md');
const SMART_DISCUSS_REF = path.join(PROJECT_ROOT, 'get-tasks-done', 'references', 'autonomous-smart-discuss.md');
