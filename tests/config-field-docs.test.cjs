...
const REFERENCE_PATH = path.join(__dirname, '..', 'get-tasks-done', 'references', 'planning-config.md');
const CORE_PATH = path.join(__dirname, '..', 'get-tasks-done', 'bin', 'lib', 'core.cjs');
