...
const SH_HOOKS = [
  { name: 'gtd-validate-commit.sh', settingsVar: 'validateCommitCommand' },
  { name: 'gtd-session-state.sh',   settingsVar: 'sessionStateCommand' },
  { name: 'gtd-phase-boundary.sh',  settingsVar: 'phaseBoundaryCommand' },
];
